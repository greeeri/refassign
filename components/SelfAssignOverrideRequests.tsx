  ...
  return <section className="card" style={{ borderColor: "#f59e0b", marginBottom: 14 }}>
    ...
    <div style={{ display: "grid", gap: 8 }}>
      {requests.map((request) => {
        ...
        return <article key={request.id} style={{ display: "grid", gridTemplateColumns: "minmax(0,1fr) auto", gap: 12, alignItems: "center", padding: 12, border: "1px solid #fde68a", borderRadius: 9, background: "#fffbeb" }}>

...
type Subscription = { id: string; organization_name: string; plan: string; status: string; stripe_subscription_id: string | null; current_period_end: string | null; cancel_at_period_end: boolean; access_override: boolean; access_override_reason: string | null; organizations: { name?: string } | { name?: string }[] | null };
